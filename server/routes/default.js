...
1. update entire list of vars from front end
2. modify schema to match --DONE!
3. create code tp save to DB
4. create .put request on line 58
5. create function on client-side to create initial values and post them to DB
